...
import "./App.jsx";
import codecrushedLogo from "../public/components/Group 9.svg";
import ctrlLogo from "../public/components/Group 12.svg";
import logo from "../public/components/EXCEL-LOGO 2 (2).svg";
import arrow from "../public/components/Arrow 3 (1).svg";
        ...
        <div className="flex justify-between w-full py-3">
          <div className="">
            <div className="flex items-center w-200px">
              <img src={arrow} alt="" className="w-[10px] mx-[10px] md:py-2" />
          ...
          <div className="p-5 gap-4">
            <img src={codecrushedLogo} alt="" className="w-[120px]" />
            <img src={ctrlLogo} alt="" className="w-[120px]" />
          </div>
        </div>
      </section>
    </div>
